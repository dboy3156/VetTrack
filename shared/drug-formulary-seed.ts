...
export const SEEDED_FORMULARY: SeededDrugFormularyEntry[] = [
  ...
  { name: "Propofol", genericName: "Propofol",         concentrationMgMl: 10,    standardDose: 4,      minDose: 2,      maxDose: 6,      doseUnit: "mg_per_kg",  defaultRoute: "IV" },
  { name: "Ketamine", genericName: "Ketamine",         concentrationMgMl: 100,   standardDose: 3.5,    minDose: 2,      maxDose: 5,      doseUnit: "mg_per_kg",  defaultRoute: "IV/IM" },
  ...
  { name: "Butorphanol", genericName: "Butorphanol",      concentrationMgMl: 10,    standardDose: 0.25,   minDose: 0.1,    maxDose: 0.4,    doseUnit: "mg_per_kg",  defaultRoute: "IV/IM/SC" },
  ...
  { name: "Dexmedetomidine", genericName: "Dexmedetomidine", brandNames: ["Dexdomitor"], concentrationMgMl: 0.5,   standardDose: 0.005,  minDose: 0.001,  maxDose: 0.01,   doseUnit: "mg_per_kg",  defaultRoute: "IV/IM" },
  { name: "Acepromazine", genericName: "Acepromazine",     concentrationMgMl: 10,    standardDose: 0.05,   minDose: 0.01,   maxDose: 0.1,    doseUnit: "mg_per_kg",  defaultRoute: "IV/IM/SC" },
  ...
  // ── Steroids ─────────────────────────────────────────────────────────────────
  { name: "Prednisolone", genericName: "Prednisolone",     concentrationMgMl: 5,     standardDose: 1,      minDose: 0.5,    maxDose: 2.2,    doseUnit: "mg_per_kg",  defaultRoute: "PO" },
  { name: "Prednisone", genericName: "Prednisone",       concentrationMgMl: 5,     standardDose: 1,      minDose: 0.5,    maxDose: 2.2,    doseUnit: "mg_per_kg",  defaultRoute: "PO" },

  // ── Oral Analgesics / Behavioral ─────────────────────────────────────────────
  { name: "Gabapentin", genericName: "Gabapentin",       concentrationMgMl: 100,   standardDose: 10,     minDose: 5,      maxDose: 20,     doseUnit: "mg_per_kg",  defaultRoute: "PO" },
  { name: "Trazodone", genericName: "Trazodone",        concentrationMgMl: 50,    standardDose: 0.14,   minDose: 0.06,   maxDose: 0.2,    doseUnit: "tablet",     defaultRoute: "PO" },
  ...
  { name: "Amlodipine", genericName: "Amlodipine",       concentrationMgMl: 5,     standardDose: 0.3,    minDose: 0.1,    maxDose: 0.5,    doseUnit: "tablet",     defaultRoute: "PO" },
  { name: "Pimobendan", genericName: "Pimobendan",       concentrationMgMl: 2.5,   standardDose: 0.1,    minDose: 0.1,    maxDose: 0.12,   doseUnit: "tablet",     defaultRoute: "PO" },
  { name: "Digoxin", genericName: "Digoxin",          concentrationMgMl: 0.25,  standardDose: 0.004,  minDose: 0.0025, maxDose: 0.005,  doseUnit: "tablet",     defaultRoute: "PO" },

  // ── Vasopressors / CRI ───────────────────────────────────────────────────────
  // Doses are typical starting rates (mcg/kg/min); use as reference — CRI protocol applies.
  { name: "Dobutamine", genericName: "Dobutamine",       concentrationMgMl: 12.5,  standardDose: 5,      minDose: 2,      maxDose: 20,     doseUnit: "mcg_per_kg", defaultRoute: "IV (CRI)" },
  { name: "Dopamine", genericName: "Dopamine",         concentrationMgMl: 40,    standardDose: 5,      minDose: 2,      maxDose: 15,     doseUnit: "mcg_per_kg", defaultRoute: "IV (CRI)" },
  { name: "Norepinephrine", genericName: "Norepinephrine",   concentrationMgMl: 1,     standardDose: 0.5,    minDose: 0.1,    maxDose: 2,      doseUnit: "mcg_per_kg", defaultRoute: "IV (CRI)" },
  ...
  { name: "Augmentin 5% 50mg/ml", genericName: "Augmentin 5% 50mg/ml", concentrationMgMl: 50, standardDose: 15,    minDose: 10,     maxDose: 50,     doseUnit: "mg_per_kg",  defaultRoute: "IV/SC" },
  { name: "Cisapride tab 2.5", genericName: "Cisapride tab 2.5", concentrationMgMl: 2.5, standardDose: 1,      minDose: 0.5,    maxDose: 2,      doseUnit: "tablet",     defaultRoute: "PO" },
  ...
  // ── Anti-emetics / GI ────────────────────────────────────────────────────────
  { name: "Maropitant", genericName: "Maropitant", brandNames: ["Cerenia"], concentrationMgMl: 10,    standardDose: 1,      minDose: 1,      maxDose: 2,      doseUnit: "mg_per_kg",  defaultRoute: "SC/IV" },
  ...
  { name: "Pantoprazole", genericName: "Pantoprazole",     concentrationMgMl: 4,     standardDose: 1,      minDose: 1,      maxDose: 1,      doseUnit: "mg_per_kg",  defaultRoute: "IV" },
  { name: "Omeprazole", genericName: "Omeprazole",       concentrationMgMl: 20,    standardDose: 0.0375, minDose: 0.025,  maxDose: 0.05,   doseUnit: "tablet",     defaultRoute: "PO" },
  ...
  { name: "Sucralfate", genericName: "Sucralfate",       concentrationMgMl: 1000,  standardDose: 0.05,   minDose: 0.025,  maxDose: 0.1,    doseUnit: "tablet",     defaultRoute: "PO" },
  ...
  { name: "Mannitol", genericName: "Mannitol",         concentrationMgMl: 200,   standardDose: 500,    minDose: 250,    maxDose: 1000,   doseUnit: "mg_per_kg",  defaultRoute: "IV (Slow)" },
  ...
  // ── Endocrine ────────────────────────────────────────────────────────────────
  { name: "Insulin Regular", genericName: "Insulin Regular",  concentrationMgMl: 100,   standardDose: 0.1,    minDose: 0.1,    maxDose: 0.2,    doseUnit: "mg_per_kg",  defaultRoute: "IV/IM/SC" },
  { name: "Levothyroxine", genericName: "Levothyroxine",    concentrationMgMl: 0.1,   standardDose: 0.2,    minDose: 0.2,    maxDose: 0.2,    doseUnit: "tablet",     defaultRoute: "PO" },
