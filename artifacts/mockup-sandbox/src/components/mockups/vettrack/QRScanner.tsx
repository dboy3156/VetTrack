      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <div className="relative w-64 h-64">
          ...
          <div
            ...
            style={{ top: "40%", height: "2px", background: "#14b8a6" }}
          />
        </div>

        <div className="mt-6 text-center">
          <div className="text-[15px] text-white font-medium">Point camera at QR code</div>
          <div className="text-[12px] text-white/40 mt-4">Equipment ID is printed on the label</div>
        </div>

        <button className="mt-6 flex items-center gap-2 px-6 py-4 rounded-full bg-white/10 text-white text-[13px] font-medium">
